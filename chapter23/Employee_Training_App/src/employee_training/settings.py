...
class Settings():
    ...
    def create_default_settings_json_file(self, 
        ...
        match platform.system():
            case 'Windows':
                ...
                settings['log_filename'] = 'employee_traning.log'
            ...
            case _:
                settings['logs_dir'] = 'logs'
                settings['log_filename'] = 'employee_training.log'
                settings['log_level'] = 'debug'
                settings['log_to_console'] = True
                settings['log_to_file'] = True
                settings['deployed_to_production'] = False    
    ...
    def read_settings_file_from_location(self, 
                                        filename='app_settings.json') -> dict:
        ...
        try:
            ...
            settings = self.create_default_settings_json_file()
