...
def main():
	...
	print(f'Bubble sorting {len(list_1)} integers. Don\'t blink!')
	(sorted_list, outerloop, innerloop, swaps, sort_time) = bs.run(list_1)
	...
	(sorted_list, outerloop, innerloop, swaps, sort_time) = bs.run(list_2)
	print(f'Outerloop: {outerloop}')
	print(f'Innerloop: {innerloop}')
	print(f'swaps: {swaps}')
	print(f'time: {sort_time:0.8f}')
	...
	(sorted_list, outerloop, innerloop, swaps, sort_time) = bs.run(list_3)
	print(f'Outerloop: {outerloop}')
	print(f'Innerloop: {innerloop}')
	print(f'swaps: {swaps}')
	print(f'time: {sort_time:0.8f}')
	...
	print(f'Bubble sorting {len(unsorted_ints):,} \
randomly-generated integers. This may take a while. Know any good jokes?')
	(sorted_list, outerloop, innerloop, swaps, sort_time) = bs.run(unsorted_ints)
	print(f'Outerloop: {outerloop:,}')
	print(f'Innerloop: {innerloop:,}')
	print(f'swaps: {swaps:,}')
	print(f'time: {sort_time:0.8f}')
